...
\optionalemph{The method of differentiating under the
integral sign}, J. Symbolic Computation \optionalbf{10}(1990), 571-591.
...
Adv. Appl. Math. \optionalbf{37} (2006), 139-152

\bibitem{goulian03}
E.~Batchelor and M.~Goulian.
\newblock {{R}obustness and the cycle of phosphorylation and dephosphorylation
  in a two-component regulatory system}.
\newblock \optionalemph{ Proc. Natl. Acad. Sci. U.S.A.}, 100:691--696, 2003.

\bibitem{receptorligandJTB04}
M.~Chaves, E.D. Sontag,  R.~J. Dinerstein.
\newblock Steady-states of receptor-ligand dynamics: {A} theoretical framework.
\newblock \optionalemph{ J. Theoret. Biol.}, 227(3):413--428, 2004.

\bibitem{conradi}
C.~Conradi, J.~Saez-Rodriguez, E.-D. Gilles,  J.~Raisch.
\newblock Using chemical reaction network theory to discard a kinetic mechanism
  hypothesis.
\newblock \optionalemph{IET Systems Biology}, 152:243 -- 248, 2005.
...
\newblock \optionalemph{ Chemical Engr. Sci.}, 42:2229--2268, 1987.

\bibitem{feinberg2}
M.~Feinberg.
\newblock The existence and uniqueness of steady states for a class of chemical
  reaction networks.
\newblock \optionalemph{ Archive for Rational Mechanics and Analysis}, 132:311--370,
  1995.

\bibitem{gil00}
D.~T. Gillespie.
\newblock The chemical Langevin equation.
\newblock \optionalemph{ Journal of Chemical Physics}, 113(1):297--306, 2000.

\bibitem{gnacadja07}
G.~Gnacadja, A.~Shoshitaishvili, M.J. Gresser, B.~Varnum, D.~Balaban, M.~Durst,
  C.~Vezina, Y.~Li.
\newblock Monotonicity of interleukin-1 receptor-ligand binding with respect to
  antagonist in the presence of decoy receptor.
\newblock \optionalemph{ Journal of J. Theoret. Biol.}, 244:478--488, 2007.

\bibitem{kelly}
F.~Kelly.
\newblock \optionalemph{ Reversibility and Stochastic Networks}.
\newblock Wiley, New York, 1979.

\bibitem{mairesse09}
J.~Mairesse and H.-T. Nguyen.
\newblock Deficiency zero Petri nets and product form, 2009.
\newblock arXiv.org:0905.3158.
...
\newblock \optionalemph{ IEEE Trans. Automat. Control}, 46(7):1028--1047, 2001.

\bibitem{wang:JNS07}
L.~Wang and E.D. Sontag.
\newblock Singularly perturbed monotone systems and an application to double
  phosphorylation cycles.
\newblock \optionalemph{ J. Nonlinear Science}, 18:527--550, 2008.
...
\bibitem{Z}
D. Zeilberger,
\optionalemph{The method of creative telescoping}, J. Symbolic Comput.
\optionalbf{11}, 195-204 (1991).
